...
const authProtectedRoutes = [
  ...
  { path: "roles-responsibilty", component: <SignState><RolesResponsibility /></SignState> },
 // { path: "/admin-user", component: <AdminUser /> },
 // { path: "/add-user", component: <AddAdmin /> },
  { path: "/community-update", component: <SignState><CommunityUpdateMaster /></SignState> },
  ...
  {path:"/edit-communitymaster/:id",component:  
  (<SignState><EditCommunityUpdateMaster /></SignState>
)},
  {
...
const publicRoutes = [
  ...
  { path: "/auth-pass-reset-basic", component: <SignState><BasicPasswReset /></SignState> },
  { path: "/auth-pass-reset-cover", component: <SignState><CoverPasswReset /></SignState> },
